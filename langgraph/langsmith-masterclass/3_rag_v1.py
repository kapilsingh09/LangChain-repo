...
PDF_PATH = os.path.join(os.path.dirname(__file__), "islr.pdf")  # <-- change to your PDF filename
print(PDF_PATH)
# 1) Load PDF
if not os.path.isfile(PDF_PATH):
    raise FileNotFoundError(f"PDF file not found: {os.path.abspath(PDF_PATH)}")
